...
class ChefsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chef" do
    assert_difference('Chef.count') do
      post chefs_url, params: { chef: { name: @chef.name, patisserie_id: @chef.patisserie_id, role: @chef.role } }, as: :json
    end
  ...
  test "should update chef" do
    patch chef_url(@chef), params: { chef: { name: @chef.name, patisserie_id: @chef.patisserie_id, role: @chef.role } }, as: :json
    assert_response 200
  end
